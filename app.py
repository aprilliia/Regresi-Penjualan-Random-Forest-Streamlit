...
with st.sidebar.subheader('2.1. Learning Parameters'):
    ...
    parameter_min_samples_leaf = st.sidebar.slider('Minimum number of samples required to be at a node (min_samples)', 1, 10, 2, 1)

with st.sidebar.subheader('2.2. General Parameters'):
    parameter_random_state = st.sidebar.slider('Speed number (random_state)', 0, 1000, 42, 1)
